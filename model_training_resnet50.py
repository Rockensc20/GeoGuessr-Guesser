...
# The ResNet50 worked far better for our use case then than ResNet50v2
...
train_checkpointer = ModelCheckpoint(
    filepath = 'models/resnet50_transfer_sgd.hdf5',
    monitor = 'val_loss',
    save_best_only = True,
    mode = 'auto',
    verbose=1
...
resnet50_transfer_fit_history = transfer_model.fit(
        train_data,
        epochs = EPOCHS,
...
print(resnet50_transfer_fit_history.history.keys())

# summarize history for accuracy
plt.plot(resnet50_transfer_fit_history.history['accuracy'])
plt.plot(resnet50_transfer_fit_history.history['val_accuracy'])
...
plt.plot(resnet50_transfer_fit_history.history['loss'])
plt.plot(resnet50_transfer_fit_history.history['val_loss'])
